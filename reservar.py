...
def main() -> int:
    ...
    with sync_playwright() as pw:
        ...
        try:
            ...
            #
            # Se probo reload() en vez de goto() para reusar la pagina que
            # asegurar_sesion() ya deja cargada — se colgo indefinidamente en una
            # prueba real (no fallo con timeout, quedo esperando para siempre).
            # Un cuelgue sin limite es mucho peor que perder unos segundos: goto()
            # al menos falla acotado a 20s y el intento puede reintentar.
